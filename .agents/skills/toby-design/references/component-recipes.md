...
| Feature browser | `Features/Sidebar/FeatureBrowser.swift` | Shared `FeatureWorkspaceSplit` + `FeatureBrowserList` (10pt horizontal inset) + `FeatureBrowserPlaceholder`. Workspace records are rows, not card grids. |
