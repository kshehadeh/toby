...
description: >-
  ...
  implement plugin protocol v1, port email/slack-style modules externally,
  or wire release/install for toby-plugin directories.
---
...
[`plugins-slack.test.ts`](../../../apps/cli/tests/plugins-slack.test.ts)):
