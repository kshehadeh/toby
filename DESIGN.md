...
| Success / error | Use an inline status for local durable feedback, a toast for an ephemeral app-wide result, the gateway-funds banner when Vercel AI Gateway or OpenRouter is out of credits, and a native alert before destructive action. |
