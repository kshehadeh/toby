...
export function registerChatCommand(program: Command): void {
	program
		...
		.argument(
			"[words...]",
			"Optional: first word may be an integration name (gmail, todoist, slack, azuread, jira); remaining words are the prompt. If the first word is not an integration, the full text is the prompt and all connected chat integrations are used.",
		)
