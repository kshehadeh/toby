...
| Project page | The selected project's details: rename in **About**; summary, persona, folder path, and file tree on the page. A **Chats** sidebar on the right lists every project chat — click one to resume it, or use **+ Chat** in the toolbar to start a new one. The toolbar also shows **Delete** and a button to hide or show the Chats sidebar. |
