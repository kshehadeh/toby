...
public enum PluginConstants {
	public static let name = "whisper"
	public static let displayName = "Whisper"
	public static let description = "Local whisper.cpp transcription for listen recordings"
...
public enum PluginOutput {
	...
	public static func isConnected(config: [String: Any], state: [String: Any]) -> Bool {
		...
		return WhisperConfig.resolve(config: config).isReady
	}
}
