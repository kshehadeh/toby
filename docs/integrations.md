...
| `dashboard?` | Optional `getSummary` for the native home dashboard (often synthesized from `standardTool` tags). Deterministic card data; AI blurbs use separate flows. See [dashboard.md](dashboard.md) and [flows.md](flows.md). |
