...
echo "Building bun-package plugins (sample-ts, todoist, slack, jira, notion, email, macos, applecontacts, applecalendar, applereminders, news)..."
for plugin in sample-ts todoist slack jira notion email macos applecontacts applecalendar applereminders news; do
