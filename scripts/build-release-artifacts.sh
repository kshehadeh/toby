...
echo "Building bun-package plugins (sample-ts, todoist, slack, jira, email, macos, applecalendar, applereminders)..."
for plugin in sample-ts todoist slack jira email macos applecalendar applereminders; do
